...
if(isset($_POST["submit"])){
    ...
    do{
      ...
      //Update Recruitment 
    $sql = "update 'recruitment' set job_title='$job_title',Requirements='$Requirements',description='$description',deadline='$deadline' where Sl_No=$id";
...
?>
  ...
  <div class="container"> 
  <h1 style="text-align:center">Update Recruitment</h1>

  <form action="j_update.php" method="POST" >
...
<?php
    ...
    <div class="row ">
      ...
      <div style="text-align:center">
            <br><button type="submit" class="submit" name ="submit">Update</button>
      </div>
    </form>
  </div>
